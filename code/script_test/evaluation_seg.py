...
gpu_mode = True
gpu_id = 0
data_root = '/home/user/Database/Database/ADE2017/images/'#image root
val_file = 'validation.txt'
save_root = '/home/user/Program/caffe-model/seg/FinalProject/SAN_384_124/predict/'
model_weights = 'SAN_se-resnet50_ADEtrain_iter_40000.caffemodel'
model_deploy = 'deploy_SAN.prototxt'
